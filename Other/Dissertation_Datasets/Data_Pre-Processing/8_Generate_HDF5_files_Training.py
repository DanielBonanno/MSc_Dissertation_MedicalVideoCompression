...
counter_patches = 0
fp_HR = open('../Training/Training_HR.txt') 
fp_LR = open('../Training/Training_LR.txt')  
fp_MC = open('../Training/Training_MC.txt')  
...
while 1:
	...
	if(len(HR_data)==250000):
		with h5py.File('../Training/Training_Data_%d.h5' %file_counter, 'w') as fp:
			fp['HR_data'] = HR_data
			fp['LR_data'] = LR_data
			fp['MC_data'] = MC_data
			HR_data = []
